...
rule solve_network_iteration0:
    input: network = "networks/{capacity_years}/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc"
    output: "results/networks/iteration0/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc"
    log:
        solver=normpath("logs/solve_network/{capacity_years}/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_solver.log"),
        python="logs/solve_network/{capacity_years}/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_python.log",
        memory="logs/solve_network/{capacity_years}/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_memory.log"
    benchmark: "benchmarks/{capacity_years}/solve_network/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}"
    threads: 4
...
rule build_optimized_capacities_iteration1:
    input:
       solved_networks=expand("results/networks/iteration0/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc", **config['scenario']),
       unprepared="networks/{capacity_years}/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc",
    output: "results/networks/iteration1/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc"
    log:
        solver=normpath("logs/build_optimized_capacities_iteration1/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_solver.log"),
        python="logs/build_optimized_capacities_iteration1/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_python.log",
        memory="logs/build_optimized_capacities_iteration1/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_memory.log"
    benchmark: "benchmarks/build_optimized_capacities_iteration1/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}"
    threads: 4
    resources: mem=(lambda w: 5000 + 372 * int(w.clusters))
    shadow: "shallow"
...
rule build_optimized_capacities_iteration2:
    input:
       solved_networks=expand("results/networks/iteration1/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc", **config['scenario']),
       unprepared="networks/{capacity_years}/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc",
    output: "results/networks/iteration2/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc"
    log:
        solver=normpath("logs/build_optimized_capacities_iteration2/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_solver.log"),
        python="logs/build_optimized_capacities_iteration2/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_python.log",
        memory="logs/build_optimized_capacities_iteration2/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_memory.log"
    benchmark: "benchmarks/build_optimized_capacities_iteration2/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}"
    threads: 4
    resources: mem=(lambda w: 5000 + 372 * int(w.clusters))
    shadow: "shallow"
...
rule build_optimized_capacities_iteration3:
    input:
       solved_networks=expand("results/networks/iteration2/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc", **config['scenario']),
       unprepared="networks/{capacity_years}/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc",
    output: "results/networks/iteration3/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc"
    log:
        solver=normpath("logs/build_optimized_capacities_iteration3/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_solver.log"),
        python="logs/build_optimized_capacities_iteration3/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_python.log",
        memory="logs/build_optimized_capacities_iteration3/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_memory.log"
    benchmark: "benchmarks/build_optimized_capacities_iteration3/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}"
    threads: 4
    resources: mem=(lambda w: 5000 + 372 * int(w.clusters))
    shadow: "shallow"
...
rule build_robust_capacities_extra_generator_iteration4:
    input: solved_biomass_networks = expand("results/networks/iteration3/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc", **config['scenario']),
        unprepared="networks/{capacity_years}/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc"
    output: "results/networks/iteration4/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc"
    log:
        solver=normpath("logs/build_robust_biomass_capacities/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_solver.log"),
        python="logs/build_robust_biomass_capacities/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_python.log",
        memory="logs/build_robust_biomass_capacities/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_memory.log"
    benchmark: "benchmarks/build_robust_biomass_capacities/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}"
    threads: 4
    resources: mem=(lambda w: 5000 + 372 * int(w.clusters))
    shadow: "shallow"
...
rule build_robust_capacities_iteration5:
    input: expand("results/networks/iteration4/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc", **config['scenario']),
        unprepared="networks/{capacity_years}/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc"
    output: "results/networks/iteration5/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc"
    log:
        solver=normpath("logs/build_robust_capacities_iteration5/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_solver.log"),
        python="logs/build_robust_capacities_iteration5/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_python.log",
        memory="logs/build_robust_capacities_iteration5/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_memory.log"
    benchmark: "benchmarks/build_robust_capacities_iteration5/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}"
    threads: 4
    resources: mem=5000
    shadow: "shallow"
...
rule build_final_robust_capacities:
    input: expand("results/networks/iteration5/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}.nc", **config['scenario']),
...
rule solve_operations_network_with_robust_capacities:
    input: capacities = "results/networks/iteration5/robust_capacities.csv",
        unprepared="networks/{capacity_years}/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}.nc"
    output: "results/networks/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op.nc"
    log:
        solver=normpath("logs/solve_operations_network_with_robust_capacities/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_solver.log"),
        python="logs/solve_operations_network_with_robust_capacities/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_python.log",
        memory="logs/solve_operations_network_with_robust_capacities/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op_memory.log",
    benchmark: "benchmarks/solve_operations_network_with_robust_capacities/{network}_s{simpl}_{clusters}_lv{lv}_{opts}_{sector_opts}_{planning_horizons}_{capacity_years}_op"
    threads: 4
    resources: mem=5000
    shadow: "shallow"
